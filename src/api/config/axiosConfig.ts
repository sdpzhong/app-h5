 ...
 * @Last Modified time: 2026-04-29 10:25:42
 * @desc: Axios 统一配置文件
 */
...
export class BaseUrls {
  static developmentBaseUrl: string = 'https://dynamic.jadosmart.com/iot';
  static productionBaseUrl: string = 'https://iotapi.jadosmart.com';
  static overseasProductionBaseUrl: string = 'https://iotapi-sg.jadosmart.com';
}
