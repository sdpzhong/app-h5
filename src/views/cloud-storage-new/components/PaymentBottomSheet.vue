...
<script setup lang="ts">
  ...
  import type { PaymentMethodItem } from '../types/cloud-storage';
  ...
  const { recommendList, selectPackageId, selectDeviceSN } = storeToRefs(useCloudStorageStore());

  const selectPackage = computed(() =>
    recommendList.value.find((e) => e.packageId === selectPackageId.value),
  );
